    ...
    <nav class="footer__nav footer-nav">
      <ul class="footer-nav__list">
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/campaign')); ?>" class="footer-nav__link">会社案内</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/information')); ?>" class="footer-nav__link">製品情報</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/blog')); ?>" class="footer-nav__link">実績</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/voice')); ?>" class="footer-nav__link">採用情報</a>
        </li>
        <li class="footer-nav__item">
      ...
      <ul class="footer-nav__list">
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/price')); ?>" class="footer-nav__link">コラム</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/contact')); ?>" class="footer-nav__link">お問合せ</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/contact')); ?>" class="footer-nav__link">プライバシーポリシー</a>
        </li>
        <li class="footer-nav__item">
          <a href="<?php echo esc_url(home_url('/contact')); ?>" class="footer-nav__link">サイトマップ</a>
        </li>
      </ul>
    </nav>
